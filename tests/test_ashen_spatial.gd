...
func _test_camera_foundation(player):
	...
	_check(is_equal_approx(camera_rig.camera_height, 10.5) and is_equal_approx(camera_rig.follow_distance, 13.5), "Camera uses the locked height/distance framing baseline.")
